...
#ifndef _DRV_SST25VF080B_H
#define _DRV_SST25VF080B_H
...
/* Driver SPI Flash Module Index reference
  ...
  Description:
    These constants provide SST25VF080B SPI Flash driver index definitions.

  Remarks:
    These constants should be used in place of hard-coded numeric literals.

    These values should be passed into the DRV_SST25VF080B_Initialize and
    DRV_SST25VF080B_Open routines to identify the driver instance in use.
*/

#define      DRV_SST25VF080B_INDEX_0      0
#define      DRV_SST25VF080B_INDEX_1      1
...
typedef SYS_FS_MEDIA_BLOCK_COMMAND_HANDLE  DRV_SST25VF080B_BLOCK_COMMAND_HANDLE;
...
#define DRV_SST25VF080B_BLOCK_COMMAND_HANDLE_INVALID   /*DOM-IGNORE-BEGIN*/ SYS_FS_MEDIA_BLOCK_COMMAND_HANDLE_INVALID /*DOM-IGNORE-END*/

// *****************************************************************************
/* SST25VF080B SPI Flash Driver Events
   ...
   Remarks:
    ...
    calling the DRV_SST25VF080B_BlockEventHandlerSet function when a block 
...
typedef enum
{
    ...
    DRV_SST25VF080B_EVENT_BLOCK_COMMAND_COMPLETE
    ...
    DRV_SST25VF080B_EVENT_BLOCK_COMMAND_ERROR
       /*DOM-IGNORE-BEGIN*/ = SYS_FS_MEDIA_EVENT_BLOCK_COMMAND_ERROR /*DOM-IGNORE-END*/

} DRV_SST25VF080B_BLOCK_EVENT;

// *****************************************************************************
/* SST25VF080B SPI Flash Driver Event Handler Function Pointer

   Summary:
    Pointer to a SST25VF080B SPI Flash Driver Event handler function.

   Description:
    This data type defines the required function signature for the SST25VF080B
  ...
  Example:
    ...
    (
        DRV_SST25VF080B_BLOCK_EVENT event,
    ...
    )
    {
        ...
        switch(event)
        {
            case DRV_SST25VF080B_EVENT_BLOCK_COMMAND_COMPLETE:

                // Handle the completed buffer. 
                break;
            
            case DRV_SST25VF080B_EVENT_BLOCK_COMMAND_ERROR:
            default:
  ...
  Remarks:
    If the event is DRV_SST25VF080B_EVENT_BLOCK_COMMAND_COMPLETE, it means that the
    data was transferred successfully. 
    
    If the event is DRV_SST25VF080B_EVENT_BLOCK_COMMAND_ERROR, it means that the data
    was not transferred successfully.
     
    The context parameter contains the a handle to the client context,  
    provided at the time the event handling function was  registered using the
    DRV_SST25VF080B_BlockEventHandlerSet function. This context handle value is
...
typedef void ( *DRV_SST25VF080B_EVENT_HANDLER ) 
(
    DRV_SST25VF080B_BLOCK_EVENT event, 
    DRV_SST25VF080B_BLOCK_COMMAND_HANDLE commandHandle,
    uintptr_t context
...
typedef enum
{
    ...
    DRV_SST25VF080B_CLIENT_STATUS_READY = DRV_CLIENT_STATUS_READY + 0,

    /* Operation in progress, unable to start a new one */
    DRV_SST25VF080B_CLIENT_STATUS_BUSY = DRV_CLIENT_STATUS_BUSY,

    /* Client is closed */
    DRV_SST25VF080B_CLIENT_STATUS_CLOSED = DRV_CLIENT_STATUS_CLOSED,
    
    /* Client Error */
    DRV_SST25VF080B_CLIENT_STATUS_ERROR = DRV_CLIENT_STATUS_ERROR

} DRV_SST25VF080B_CLIENT_STATUS;
...
/* SST SPI Flash Driver Initialization Data
  ...
  Remarks:
    ...
    initialization data must be passed into the DRV_SST25VF080B_Initialize
    function.
*/
...
typedef struct
{
    ...
    /* This is the buffer queue size. This is the maximum
       ...
       DRV_SST25VF080B_QUEUE_SIZE macro in system_config.h */
    uint32_t queueSize;

} DRV_SST25VF080B_INIT;
...
/* Function:
  ...
  Summary:
    Initializes the SST25VF080B SPI Flash Driver instance for the specified
    driver index.
  ...
  Example:
    <code>
    // This code snippet shows an example of initializing the SST25VF080B SPI
    ...
    DRV_SST25VF080B_INIT   SST25VF080BInitData;
    SYS_MODULE_OBJ      objectHandle;
    
    SST25VF080BInitData.moduleInit.value      = SYS_MODULE_POWER_RUN_FULL;
    SST25VF080BInitData.spiDriverModuleIndex  = DRV_SPI_INDEX_0; 
    SST25VF080BInitData.holdPortChannel       = PORT_CHANNEL_B;
    SST25VF080BInitData.holdBitPosition       = PORTS_BIT_POS_1;
    SST25VF080BInitData.writeProtectPortChannel = PORT_CHANNEL_B;
    SST25VF080BInitData.writeProtectBitPosition = PORTS_BIT_POS_2;
    SST25VF080BInitData.chipSelectPortChannel = PORT_CHANNEL_F;
    SST25VF080BInitData.chipSelectBitPosition = PORTS_BIT_POS_2;
    SST25VF080BInitData.queueSize = 5;
    
    objectHandle = DRV_SST25VF080B_Initialize(DRV_SST25VF080B_INDEX_0,
                                    (SYS_MODULE_INIT*)SST25VF080BInitData);
  ...
  Remarks:
    ...
    unless DRV_SST25VF080B_Deinitialize is called to deinitialize the driver
    instance.
...
/* Function:
  ...
  Precondition:
    Function DRV_SST25VF080B_Initialize should have been called before calling
    this function.
    
  Parameters:
    object -  Driver object handle, returned from the DRV_SST25VF080B_Initialize
              function
  Returns:
    None.
  ...
  Example:
    ...
    SYS_MODULE_OBJ      object;     //  Returned from DRV_SST25VF080B_Initialize
    SYS_STATUS          status;
    
    
    DRV_SST25VF080B_Deinitialize(object);
    
    status = DRV_SST25VF080B_Status(object);
...
/* Function:
  ...
  Example:
    <code>
    SYS_MODULE_OBJ      object;     // Returned from DRV_SST25VF080B_Initialize
    SYS_STATUS          SST25VF080BStatus;
    
    SST25VF080BStatus = DRV_SST25VF080B_Status(object);
    else if (SYS_STATUS_ERROR >= SST25VF080BStatus)
    {
        // Handle error
    }
    </code>
...
/* Function:
  ...
  Precondition:
    The DRV_SST25VF080B_Initialize function must have been called for the
    specified SPI Flash driver instance.
  
  Parameters:
    object -  Object handle for the specified driver instance (returned from
              DRV_SST25VF080B_Initialize)
  Returns:
    None.
...
/* Function:
  ...
  Precondition:
    Function DRV_SST25VF080B_Initialize must have been called before calling
    this function.
  ...
  Returns:
    ...
    - if the number of client objects allocated via
         DRV_SST25VF080B_CLIENTS_NUMBER is insufficient
    ...
    The driver status becomes ready inside "DRV_SST25VF080B_Tasks" function. To
  ...
  Example:
    ...
    handle = DRV_SST25VF080B_Open(DRV_SST25VF080B_INDEX_0, 
  ...
  Remarks:
    ...
    The handle returned is valid until the DRV_SST25VF080B_Close function is
    called.
...
/* Function:
  ...
  Precondition:
    ...
    DRV_SST25VF080B_Open must have been called to obtain a valid opened device
    handle.
  ...
  Example:
    <code>
    DRV_HANDLE handle;  // Returned from DRV_SST25VF080B_Open

    DRV_SST25VF080B_Close(handle);
    </code>
  ...
  Remarks:
    ...
    calling DRV_SST25VF080B_Open before the caller may use the driver again.
...
/* Function:
  ...
  Precondition:
    The DRV_SST25VF080B_Initialize function must have been called.
  ...
  Returns:
    A DRV_SST25VF080B_CLIENT_STATUS value describing the current status of the
    driver.
  
  Example:
    <code>
    DRV_HANDLE      handle;         // Returned from DRV_SST25VF080B_Open
    DRV_SST25VF080B_CLIENT_STATUS     clientStatus;
    
    clientStatus = DRV_SST25VF080B_ClientStatus(handle);
    if(DRV_SST25VF080B_CLIENT_STATUS_READY == clientStatus)
    {
        // do the tasks
    }
    </code>
...
DRV_SST25VF080B_CLIENT_STATUS   DRV_SST25VF080B_ClientStatus( const DRV_HANDLE handle );
...
/* Function:
  ...
  Example:
    ...
    // mySST25VF080BHandle is the handle returned 
    // by the DRV_SST25VF080B_Open function.
    
    // Client registers an event handler with driver. This is done once.

    DRV_SST25VF080B_BlockEventHandlerSet( mySST25VF080BHandle, 
                    APP_SST25VF080BEventHandler, (uintptr_t)&myAppObj );

    DRV_SST25VF080B_BlockRead( mySST25VF080BHandle, commandHandle,
                                            &myBuffer, blockStart, nBlock );

    if(DRV_SST25VF080B_BLOCK_COMMAND_HANDLE_INVALID == commandHandle)
    {
        // Error handling here
    }
    ...
    void APP_SST25VF080BEventHandler(DRV_SST25VF080B_BLOCK_EVENT event, 
            DRV_SST25VF080B_BLOCK_COMMAND_HANDLE handle, uintptr_t context)
    {
...
/* Function:
  ...
  Description:
    ...
    The function returns DRV_SST25VF080B_BLOCK_COMMAND_HANDLE_INVALID in the
    ...
    erase operation was successful or DRV_SST25VF080B_EVENT_ERASE_ERROR
  ...
  Precondition:
    ...
    in the DRV_SST25VF080B_Open call.
  ...
  Parameters:
    ...
    commandHandle -  Pointer to an argument that will contain the return buffer
                   handle
    blockStart -   Start block address in SST25VF080B memory from where the
  ...
  Example:
    ...
    DRV_SST25VF080B_BlockErase( mySST25VF080BHandle, commandHandle,
                                                        blockStart, nBlock );
    ...
    void APP_SST25VF080BEventHandler(DRV_SST25VF080B_BLOCK_EVENT event, 
            DRV_SST25VF080B_BLOCK_COMMAND_HANDLE commandHandle, uintptr_t contextHandle)
    {
        // contextHandle points to myAppObj.

        switch(event)
        {
            case DRV_SST25VF080B_EVENT_ERASE_COMPLETE:

                // This means the data was transferred. 
                break;
            
            case DRV_SST25VF080B_EVENT_ERASE_ERROR:
...
/* Function:
  ...
  Description:
    ...
    returns DRV_SST25VF080B_BLOCK_COMMAND_HANDLE_INVALID in the commandHandle
    ...
    - if the driver handle is invalid 
    If the requesting client registered an event callback with the driver, the
    driver will issue a DRV_SST25VF080B_EVENT_BLOCK_COMMAND_COMPLETE event if the
    buffer was processed successfully of DRV_SST25VF080B_EVENT_BLOCK_COMMAND_ERROR
  ...
  Example:
    ...
    uint32_t blockStart = SST25VF080B_BASE_ADDRESS_TO_READ_FROM;
    uint32_t    nBlock = 2;
    DRV_SST25VF080B_BLOCK_COMMAND_HANDLE commandHandle;
    MY_APP_OBJ myAppObj;    
...
/* Function:
  ...
  Description:
    ...
    If the requesting client registered an event callback with the driver, the
    driver will issue a DRV_SST25VF080B_EVENT_BLOCK_COMMAND_COMPLETE event if the
    buffer was processed successfully or DRV_SST25VF080B_EVENT_BLOCK_COMMAND_ERROR
    event if the buffer was not processed successfully.
  ...
  Precondition:
    ...
    DRV_SST25VF080B_Open must have been called to obtain a valid opened
    device handle.
    ...
    using the API DRV_SST25VF080B_BlockErase().
  ...
  Parameters:
    ...
    blockStart -   Start block address of SST25VF080B Flash where the write 
  ...
  Example:
    ...
    // address should be block aligned.
    uint32_t blockStart = SST25VF080B_BASE_ADDRESS_TO_WRITE_TO;
    uint32_t    nBlock = 2;
    DRV_SST25VF080B_BLOCK_COMMAND_HANDLE commandHandle;
    MY_APP_OBJ myAppObj;    
    ...
    DRV_SST25VF080B_BlockWrite( mySST25VF080BHandle, commandHandle,
                                            &myBuffer, blockStart, nBlock );
...
// *****************************************************************************
/* Function:
    void DRV_SST25VF080B_BlockEraseWrite
    (
        const DRV_HANDLE handle,
        DRV_SST25VF080B_BLOCK_COMMAND_HANDLE * commandHandle,
        void * sourceBuffer,
  ...
  Description:
    ...
    DRV_SST25VF080B_BLOCK_COMMAND_HANDLE_INVALID in the commandHandle argument under the 
    ...
    If the requesting client registered an event callback with the driver, the
    driver will issue a DRV_SST25VF080B_EVENT_BLOCK_COMMAND_COMPLETE event if the buffer
    was processed successfully or DRV_SST25VF080B_EVENT_ERASE_ERROR event if 
...
/* Function:
  ...
  Returns:
    A DRV_SST25VF080B_COMMAND_STATUS value describing the current status of the
    buffer.
    Returns DRV_SST25VF080B_BLOCK_COMMAND_HANDLE_INVALID if the client handle
    or the command handle is not valid.

  Example:
    <code>
    DRV_HANDLE      sstOpenHandle;   // Returned from DRV_SST25VF080B_Open
    DRV_SST25VF080B_BLOCK_COMMAND_HANDLE  commandHandle;
    DRV_SST25VF080B_BlockErase
                            (
                                sstOpenHandle,
                                &commandHandle,
                                0,
    ...
    if(DRV_SST25VF080B_CommandStatus(sstOpenHandle, commandHandle) == DRV_SST25VF080B_COMMAND_COMPLETED );
    {
        // do something
    }
    </code>
...
/* Function:
  ...
  Example:
    ...
    sstFlashGeometry = DRV_SST25VF080B_GeometryGet(sstOpenHandle1);
...
/* Function:
  ...
  Example:
    ...
    if (DRV_SST25VF080B_MediaIsAttached(handle))
    {
    // Do Something
    }
...
// #include "driver/SST25VF080B/drv_SST25VF080B_mapping.h"
...
#endif // #ifndef _DRV_SST25VF080B_H
/*******************************************************************************
 End of File
*/
