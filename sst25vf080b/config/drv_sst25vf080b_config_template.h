/*******************************************************************************
 SST25VF080B Driver Configuration Template

  Company:
    Microchip Technology Inc.

  File Name:
    drv_sst25vf080b_config_template.h
...
#ifndef _DRV_SST25VF080B_CONFIG_TEMPLATE_H
#define _DRV_SST25VF080B_CONFIG_TEMPLATE_H
...
#define DRV_SST25VF080B_MODE                              DYNAMIC

// *****************************************************************************
/* SST25VF080B driver objects configuration
  ...
  Description
    ...
    SST25VF080B modules that are needed by the application. Hardware Instance
...
#define DRV_SST25VF080B_INSTANCES_NUMBER                      2


// *****************************************************************************
/* SST25VF080B Client Count Configuration
  ...
  Description:
    ...
    across all hardware instances. So if SST25VF080B-1 will be accessed by 2 clients
    and SST25VF080B-2 will accessed by 3 clients, then this number should be 5. 
    ...
    If this macro is not defined and the DRV_SST25VF080B_INSTANCES_NUMBER macro is not
    defined, then the driver will be built for static - single client operation.
    If this macro is defined and the DRV_SST25VF080B_INSTANCES_NUMBER macro is not
...
#define DRV_SST25VF080B_CLIENTS_NUMBER                      4

// *****************************************************************************
/* SST25VF080B Driver Instance combined queue depth.
  ...
  Description:
    ...
    entries that will be available for use between all SST25VF080B driver hardware
...
#define  DRV_SST25VF080B_QUEUE_DEPTH_COMBINED      7

// *****************************************************************************
/* SST25VF080B Hardware Write Protect Support
...
#define DRV_SST25VF080B_HARDWARE_WRITE_PROTECTION_ENABLE    false

// *****************************************************************************
/* SST25VF080B Hardware HOLD Support
...
#define DRV_SST25VF080B_HARDWARE_HOLD_ENABLE    false

#endif // #ifndef _DRV_SST25VF080B_CONFIG_TEMPLATE_H
