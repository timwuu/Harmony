/*******************************************************************************
  ...
  File Name:
    drv_sst25vf080b_erasewrite.c

  Summary:
    Source code for the SST25VF080B Erase write feature implementation.

  Description:
    This file implements the SST25VF080B Driver Erase Write function.
    This file should be included in the project if SST25VF080B driver Erase Write
...
)
{
    ...
    for(iEntry = 0 ; iEntry < DRV_SST25VF080B_QUEUE_DEPTH_COMBINED; iEntry ++)
    {
        if(!gDrvSST25VF080BBufferObj[iEntry].inUse)
        {
            ...
            bufferObj->operation = DRV_SST25VF080B_BLOCK_ERASE_WRITE;
