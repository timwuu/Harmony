/*******************************************************************************
  SST25VF080B Driver Variant Mapping

  Company:
    Microchip Technology Inc.

  File Name:
    drv_sst25vf080b_variant_mapping.h
...
#ifndef _DRV_SST25VF080B_FEATURE_MAPPING_H
#define _DRV_SST25VF080B_FEATURE_MAPPING_H
...
*/
...
#if (DRV_SST25VF080B_HARDWARE_WRITE_PROTECTION_ENABLE == true)
    ...
    #define _DRV_SST25VF080B_HardwareWPIsEnabled()      true
#else
    #define _DRV_SST25VF080B_HardwareWPIsEnabled()      false
...
*/
#if (DRV_SST25VF080B_HARDWARE_HOLD_ENABLE == true)
    ...
    #define _DRV_SST25VF080B_HardwareHoldIsEnabled()    true
#else
    #define _DRV_SST25VF080B_HardwareHoldIsEnabled()    false
...
#endif //_DRV_SST25VF080B_FEATURE_MAPPING_H
